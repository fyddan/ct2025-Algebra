...
\begin{document}
	...
	\section{Формула Гаусса для символа Лежандра (с доказательством). Вы-
		числение \texorpdfstring{$\left(\frac{2}{p}\right)$}{2/p}
	}
	...
	\section{Классификация автоморфизмов C над R, модуль комплексного чис-
		ла. Его мультипликативность. Оценка суммы.}
